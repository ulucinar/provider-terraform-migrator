module github.com/ulucinar/migration

go 1.19

require (
	github.com/upbound/upjet v0.8.0-rc.0.0.20221214123739-15411ad4889d
...
require (
	...
	github.com/crossplane-contrib/provider-aws v0.33.0 // indirect
	...
	github.com/upbound/provider-aws v0.18.0 // indirect
	github.com/upbound/provider-terraform v0.2.0 // indirect
...
replace github.com/upbound/upjet => ../upbound/upbound-upjet
